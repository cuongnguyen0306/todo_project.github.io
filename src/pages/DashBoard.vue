...
export default {
    data() {
        return {
            projects: [
                { id: 1, title: 'IMDB', name: 'USER_NAME', due: '1/1/2023', status: 'overdue'},
                { id: 2, title: 'Front end', name: 'Cường Nguyễn', due: '03/06/2023', status: 'completed'},
                { id: 3, title: 'Backend', name: 'Vidya Keerthi', due: '3/6/2023', status: 'completed'},
                { id: 4, title: 'Database', name: 'Nguyễn Cường', due: '3/6/2023', status: 'completed'},
            ]
        }
    },
    methods: {
